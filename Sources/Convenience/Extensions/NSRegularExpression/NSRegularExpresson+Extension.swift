...
public extension Regex {
    ...
    internal var descriptor: Descriptor { Descriptor(regex: self) }
...
public extension Regex {
    ...
    ///
    /// Strongly recommend to use CharacterSet.alphanumerics
    ///
    /// Word characters:
    /// - a-z
    /// - A-Z
    ...
    ///
    /// Strongly recommend to use CharacterSet.letters
    ///
    /// Expression string:
    ...
    ///
    /// Strongly recommend to use CharacterSet.decimalDigits
    ///
    /// Expression string:
    ...
    ///
    /// Strongly recommend to use CharacterSet.hexDigits
    ///
    /// Expression string:
    ...
    ///
    /// Strongly recommend to use CharacterSet.binaryDigits
    ///
    /// Expression string:
